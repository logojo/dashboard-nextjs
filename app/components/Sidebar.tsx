     ...
     <div id="menu" 
        ...
        <div id="profile" className="px-6 py-10">
            ...
            <a href="#" className="inline-flex space-x-2 items-center">
                <span>
                    <img width={10} height={10} className="rounded-full w-8 h-8" src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=128&q=80" alt="" />
                </span>
